...
router.get(
  ...
  async (request: Request, response: Response) => {
    try {
      ...
      const result = await groupUserController.getUsers(
        groupId as string,
        username as string
      );
...
router.get(
  ...
  async (request: Request, response: Response) => {
    try {
      ...
      const result = await groupUserController.getUsersWithoutCreator(
        groupId as string,
        username as string,
        token as string
      );
...
router.delete(
  ...
  async (request: Request, response: Response) => {
    try {
      ...
      const result = await groupUserController.deleteGroupUser(
        memberId as string,
        groupUser.role,
        groupId as string
      );
...
router.put(
  ...
  async (request: Request, response: Response) => {
    try {
      ...
      const result = await groupUserController.changeRole(
        groupId as string,
        userId as string,
        groupUser.role
      );
...
router.get(
  ...
  async (request: Request, response: Response) => {
    try {
      ...
      const result = await groupUserController.isMemberOfGroup(
        groupId as string,
        userId as string
      );
      response.status(200).json(result);
